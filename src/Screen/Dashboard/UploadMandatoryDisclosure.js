...
export default function UploadMandatoryDisclosure() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.log("uploaded product response", response.data.PdfDataMandatory);
  ...
  return (
    <div className="upload-container">
      <h3 className="upload-title">Upload Mandatory Disclosure</h3>
      ...
      <div className="upload-form">
        ...
        <input
          ...
          className="upload-input"
        />
        <button onClick={submitHandlerMandatoryPDf} className="upload-button">
          <p>Upload</p>
        </button>
      </div>
      {/* <div>
