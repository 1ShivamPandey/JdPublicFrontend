...
export default function UploadSchoolActivities() {
  ...
  const deleteHandler = async (id) => {
    try {
      const response = await axios.delete(
        `${BASE_URL}/api/Dashboard/school/SchoolActivities/${id}`
      );
  ...
  return (
    <div className="upload-container">
      <h3 className="upload-title">Upload School Activities Images</h3>
      ...
      <div className="upload-form">
        ...
        <input
          ...
          className="upload-input"
        />
        <button onClick={submitSchoolActivities} className="upload-button">
          <p>Upload</p>
        </button>
      </div>
